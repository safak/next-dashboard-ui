...
import { AddPatients } from "@/components/patient";

interface DataTableToolbarProps<TData> {
  table: Table<TData>;
}

export function DataTablePatientToolbar<TData>({
  table,
  ...
  const handleDateSelect = ({ from, to }: { from: Date; to: Date }) => {
    ...
    table.getColumn("admisDate")?.setFilterValue([from, to]) || table.getColumn("exeptedDate")?.setFilterValue([from, to])
  };
