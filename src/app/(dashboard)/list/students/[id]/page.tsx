    ...
    <div className="flex-1 p-4 flex flex-col gap-4 xl:flex-row">
      ...
      <div className="flex-1 flex gap-4 justify-between flex-wrap">
        ...
        <div className="bg-white p-4 rounded-md flex gap-4 w-full md:w-[48%] xl:w-[45%] 2xl:w-[48%]">
            ...
            <div className="">
                <h1 className="text-xl font-semibold">2nd Year</h1>
      ...
      <div className="bg-white p-4 rounded-md">
        ...
        <div className="mt-4 flex gap-4 flex-wrap text-xs text-gray-500">
            <Link className="p-3 rounded-md bg-lamaSkyLight" href="">Students Lessons</Link>
            <Link className="p-3 rounded-md bg-lamaPurpleLight" href="">Students Instructor</Link>
            <Link className="p-3 rounded-md bg-pink-50" href="">Students Exams</Link>
            <Link className="p-3 rounded-md bg-lamaSkyLight" href="">Students Assignments</Link>
            <Link className="p-3 rounded-md bg-lamaYellowLight" href="">Students Results</Link>
        </div>
      </div>
      <Performance />
      <Announcements />
